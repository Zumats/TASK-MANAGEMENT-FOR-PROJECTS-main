    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-14 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md relative z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="mt-2 text-sm text-white/60 text-center">Sign in to manage your tasks</p>
        </div>
        ...
        <form
          ...
          onSubmit={async (e) => {
            ...
            setLoading(true);
            try {
              const res = await apiPost<{ user: unknown; token: string }>("/api/auth/login", { email, password });
        ...
        >
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                suppressHydrationWarning
                className="w-full rounded-xl border border-white/15 bg-white/10 pl-10 pr-10 py-3 text-sm text-white placeholder:text-white/40 outline-none focus:border-blue-500/50 focus:bg-white/15 transition-all"
                value={password}
          ...
          <button
            disabled={loading}
            className="w-full rounded-xl bg-gradient-to-r from-blue-500 to-purple-600 px-4 py-3 text-sm font-semibold text-white shadow-lg shadow-blue-500/25 transition-all hover:shadow-blue-500/40 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 disabled:cursor-not-allowed disabled:hover:scale-100 flex items-center justify-center gap-2"
            type="submit"
            suppressHydrationWarning
          >
            {loading ? (
